...
def get_leetcode_calendar(username):
    ...
    # Calculate submissions for December 2025 (or current year)
    target_month = 12
    target_year = 2024 # Using 2024 as 2025 is future in real time, though user env says 2025. 
    # Wait, user env says 2025-12-26. So I should check Dec 2025.
    ...
    for s in stats:
        if s['difficulty'] == 'All':
            print(f"Total Solved (Lifetime): {s['count']}")

# Test with a known user (e.g., 'leetcode' or a popular user)
get_leetcode_calendar("neal_wu") 
