...
# Load environment variables manually since we can't load django settings easily without setup
...
# Fallback to os.environ if not in .env file
...
db_host = env.get('DB_HOST') or os.environ.get('DB_HOST')
